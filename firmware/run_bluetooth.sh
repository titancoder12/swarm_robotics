...
Examples:
  ...
  bash firmware/run_bluetooth.sh --camera-detector-mode apriltag --camera-apriltag-id 0
  bash firmware/run_bluetooth.sh --camera-detector-mode hsv --camera-hsv-lower 35,70,70 --camera-hsv-upper 100,255,255
