...
PRIMARY_SEEDS = list(range(100, 150))
...
def write_notes() -> None:
    text = """# Stronger Focused Pheromone Experiment Plan
...
def main() -> None:
    ...
    for n_agents in SWARM_SIZES:
        seeds = PRIMARY_SEEDS if n_agents == 6 else SUPPORTING_SEEDS
        for seed in seeds:
            for condition in conditions:
                ...
                raw_rows.append(
                    {
                        "family": "focused_pheromone_ablation_stronger",
    ...
    stat_pairs = [
        ...
        (6, "trained_with_pheromone__eval_with_pheromone", "trained_without_pheromone__eval_without_pheromone", "post_discovery_deliveries"),
    ...
    manifest = {
        ...
        "design": "stronger matched-training repeated-source pheromone ablation",
    }
