...
Timestamped campaign folder: `20260406_130911`
...
- The chosen design reuses existing checkpoints where possible and evaluates each condition over 5 deterministic episodes with matched controls.
