...
def main() -> None:
    ...
    conditions = [
        ...
        },
        {
            ...
            "checkpoint_dir": ROOT / "checkpoints" / "mappo_g_no_pher_true" / "stage3b_full_swarm_final",
            "pheromone_enabled": False,
        },
    ]
    ...
    for n_agents in SWARM_SIZES:
        print(f"[campaign] running n_agents={n_agents}")
    ...
    manifest = {
        ...
        "design": "extended repeated-source pheromone ablation up to 30 agents",
    }
