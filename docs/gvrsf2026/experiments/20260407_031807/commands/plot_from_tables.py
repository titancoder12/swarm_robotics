...
def main():
    ...
    rows = load_rows()
    line_metric_plot(rows, "food_delivered", "food_delivered_by_swarm_size.png", "Chokepoint Study: Deliveries by Swarm Size")
    line_metric_plot(rows, "late_deliveries", "late_deliveries_by_swarm_size.png", "Chokepoint Study: Late Deliveries by Swarm Size")
    line_metric_plot(rows, "post_discovery_deliveries", "post_discovery_deliveries_by_swarm_size.png", "Chokepoint Study: Post-Discovery Deliveries by Swarm Size")
    line_metric_plot(rows, "delivery_conversion", "delivery_conversion_by_swarm_size.png", "Chokepoint Study: Delivery Conversion by Swarm Size")
    line_metric_plot(rows, "exploration_coverage", "exploration_coverage_by_swarm_size.png", "Chokepoint Study: Exploration Coverage by Swarm Size")
    line_metric_plot(rows, "pickup_to_delivery_latency", "pickup_to_delivery_latency_by_swarm_size.png", "Chokepoint Study: Pickup-to-Delivery Latency")
