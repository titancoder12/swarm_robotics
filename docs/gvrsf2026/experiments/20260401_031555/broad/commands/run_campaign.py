...
BASE_DIR = ROOT / "docs" / "gvrsf2026" / "experiments" / TIMESTAMP / "broad"
...
This campaign prioritizes the strongest feasible evaluation-heavy subset of the GVRSF plan:
...
def main() -> None:
    ...
    save_csv(RAW_DIR / "all_episode_results.csv", all_rows)
