...
Timestamped campaign folder: `20260406_132534`
...
- The chosen design reuses existing checkpoints where possible and evaluates each condition over 8 deterministic episodes with matched controls.
