...
The overall broad scaling story is still strong, but the figure shown here is the 3-condition comparison plot so the reader can directly compare the pheromone and no-pheromone trajectories on the same axes.
