...
The broad scaling curve still rises strongly overall, though it is not perfectly monotonic at every intermediate size. The swarm-level scaling story remains visible.
