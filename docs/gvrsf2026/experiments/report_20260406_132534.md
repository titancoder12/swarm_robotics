...
The overall broad scaling story is still strong, though the curve is not perfectly monotonic at every intermediate size. This broad figure shows how the main trained policy scales with swarm size in the general evaluation family.
