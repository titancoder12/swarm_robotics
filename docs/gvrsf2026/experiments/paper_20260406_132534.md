...
![Broad Scaling: Delivery Conversion](./20260406_132534/figures/scaling_delivery_conversion.png)

![Broad Scaling: Exploration Coverage](./20260406_132534/figures/scaling_exploration_coverage.png)

### Interpretation

Broad scaling remains easy to see qualitatively. The curve is not perfectly smooth, but the general upward trend with larger swarm size is still present. This broad scaling family is still a single-condition plot, so it should be read as “how the main trained policy scales,” not as the main cross-condition pheromone comparison.
