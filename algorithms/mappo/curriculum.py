...
class CurriculumStage:
    ...
    obstacle_layout: str | None = None
    obstacle_layout_gap_size: float | None = None
    obstacle_layout_wall_thickness: int | None = None
    obstacle_layout_gap_jitter: float | None = None
    obstacle_layout_agent_spawn_radius: float | None = None
    obstacle_layout_target_offset_radius: float | None = None
    food_source_capacity: int | None = None
...
def default_curriculum(full_agents: int) -> list[CurriculumStage]:
    ...
    stages.append(
        CurriculumStage(
            name="stage2c1_small_swarm_single_gap_bridge",
            n_agents=small_agents,
            total_steps=0,
            budget_weight=2,
            width=620,
            ...
            n_obstacles=2,
            obstacle_min_size=48,
            obstacle_max_size=84,
            max_steps=360,
            active_targets=1,
            target_respawn=False,
            food_source_capacity=6,
            action_repeat_steps=1,
            reward_new_cell=0.003,
            reward_step=-0.007,
            reward_collision=-0.9,
            reward_pickup=6.5,
            reward_nest_approach=0.24,
            reward_nest_approach_sustained=0.09,
            reward_nest_delivery=38.0,
            reward_undelivered_food=-13.0,
            reward_food_approach=0.032,
            reward_food_detected=0.16,
            reward_pheromone_follow=0.025,
            carrying_reward_new_cell_scale=0.0,
            carrying_no_progress_penalty=-0.045,
            carrying_low_displacement_penalty=-0.022,
            carrying_progress_epsilon=2.2,
            carrying_low_displacement_threshold=3.2,
            carrying_stall_trigger_steps=5,
            pheromone_enabled=True,
            obstacle_layout="single_gap_vertical",
            obstacle_layout_gap_size=260.0,
            obstacle_layout_wall_thickness=70,
            obstacle_layout_gap_jitter=30.0,
            obstacle_layout_agent_spawn_radius=55.0,
            obstacle_layout_target_offset_radius=25.0,
            post_delivery_cooldown_steps=10,
            post_delivery_exit_radius=84.0,
            post_delivery_outward_reward=0.035,
            post_delivery_loiter_penalty=-0.012,
            post_delivery_pheromone_suppression_radius=95.0,
            post_delivery_require_exit=True,
            post_delivery_crowding_penalty=-0.008,
    ...
    stages.append(
        CurriculumStage(
            name="stage2c2_small_swarm_single_gap_route_reuse",
            n_agents=small_agents,
            total_steps=0,
            budget_weight=3,
            width=900,
            ...
            reward_pickup=6.0,
            reward_nest_approach=0.20,
            reward_nest_approach_sustained=0.08,
            reward_nest_delivery=36.0,
            reward_undelivered_food=-12.0,
            reward_food_approach=0.03,
            reward_food_detected=0.15,
            reward_pheromone_follow=0.03,
            carrying_reward_new_cell_scale=0.0,
            carrying_no_progress_penalty=-0.05,
            carrying_low_displacement_penalty=-0.025,
            carrying_progress_epsilon=2.4,
            carrying_low_displacement_threshold=3.6,
            carrying_stall_trigger_steps=5,
            pheromone_enabled=True,
            obstacle_layout="single_gap_vertical",
            obstacle_layout_gap_size=210.0,
            obstacle_layout_wall_thickness=80,
            obstacle_layout_gap_jitter=50.0,
            obstacle_layout_agent_spawn_radius=60.0,
            obstacle_layout_target_offset_radius=40.0,
            post_delivery_cooldown_steps=12,
            post_delivery_exit_radius=90.0,
            post_delivery_outward_reward=0.04,
            post_delivery_loiter_penalty=-0.015,
            post_delivery_pheromone_suppression_radius=110.0,
            post_delivery_require_exit=True,
            post_delivery_crowding_penalty=-0.010,
            post_delivery_crowding_threshold=2,
            entropy_start=0.008,
            entropy_end=0.001,
        )
