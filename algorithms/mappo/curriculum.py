...
def default_curriculum(full_agents: int) -> list[CurriculumStage]:
    ...
    stages.append(
        CurriculumStage(
            ...
            non_carrying_nest_loiter_radius=120.0,
            non_carrying_nest_loiter_penalty=-0.05,
            non_carrying_nest_crowding_radius=145.0,
            non_carrying_nest_crowding_penalty=-0.05,
            non_carrying_nest_crowding_threshold=2,
            non_carrying_explore_radius=220.0,
            non_carrying_outward_reward=0.08,
            non_carrying_no_outward_progress_penalty=-0.06,
            non_carrying_idle_near_nest_penalty=-0.05,
    ...
    stages.append(
        CurriculumStage(
            ...
            pheromone_enabled=True,
            non_carrying_nest_pheromone_suppression_radius=120.0,
            non_carrying_nest_loiter_radius=130.0,
            non_carrying_nest_loiter_penalty=-0.06,
            non_carrying_nest_crowding_radius=160.0,
            non_carrying_nest_crowding_penalty=-0.06,
            non_carrying_nest_crowding_threshold=2,
            non_carrying_explore_radius=260.0,
            non_carrying_outward_reward=0.09,
            non_carrying_no_outward_progress_penalty=-0.07,
            non_carrying_idle_near_nest_penalty=-0.06,
    ...
    stages.append(
        CurriculumStage(
            ...
            non_carrying_nest_loiter_penalty=-0.08,
            non_carrying_nest_crowding_radius=190.0,
            non_carrying_nest_crowding_penalty=-0.08,
            non_carrying_nest_crowding_threshold=2,
            non_carrying_explore_radius=320.0,
            non_carrying_outward_reward=0.10,
            non_carrying_no_outward_progress_penalty=-0.10,
            non_carrying_idle_near_nest_penalty=-0.08,
